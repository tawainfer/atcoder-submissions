// https://atcoder.jp/contests/abc267/submissions/34535996
...
int main() {
  ...
  vector<string> ptn;
ptn.push_back("");
ptn.push_back("Friday");
ptn.push_back("Thursday");
ptn.push_back("Wednesday");
ptn.push_back("Tuesday");
ptn.push_back("Monday");

  for(int i = 1; i <= 5; i++) if(s == ptn[i]) cout << i;
  return 0;
}
