// https://atcoder.jp/contests/abc146/submissions/35179977
...
bool is_exceed(ll n, ll a, ll b, ll x) {
  if(a * n + b * to_string(n).size() > x) return true;
  else return false;
}
